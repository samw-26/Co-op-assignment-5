...
public partial class PubsContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.JobId).HasName("PK__jobs__6E32B6A5B81D4CCD");
        ...
        {
            entity.HasNoKey();
            entity.ToTable("INFORMATION_SCHEMA.TABLES");
            entity.Property(e => e.Table).HasColumnName("TABLE_NAME");
            entity.Property(e => e.Schema).HasColumnName("TABLE_SCHEMA");
        });
